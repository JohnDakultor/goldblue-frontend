        ...
        <Box sx={{ maxWidth: 400, mx: "auto", mt: 10, p: 3 }}>
            ...
            <Card className="withdraw-page" sx={{ mt: 2, p: 3 }}>
                <CardContent>
                    ...
                    <form onSubmit={handleSubmit}>
                        <FormControl fullWidth margin="normal">
                            ...
                            <Select
                                ...
                                onChange={(e) => {
                                    setMethod(e.target.value);
                                    setAccountName(""); // Reset account name when changing method
                                    setAccountNumber(""); // Reset account number when changing method
                                }}
                            >
                                <MenuItem value="trx">TRX</MenuItem>
                    ...
                    {/* Messages */}
                    <Snackbar open={Boolean(errorMessage)} autoHideDuration={6000} onClose={handleCloseSnackbar} message={errorMessage} />
                    <Snackbar open={Boolean(successMessage)} autoHideDuration={6000} onClose={handleCloseSnackbar} message={successMessage} />
                    {withdrawalMessage && (
                        <Typography variant="body2" color="error" sx={{ mt: 2 }}>
                            {withdrawalMessage}
                        </Typography>
